...
namespace ClinicaVeterinaria.Data
{
    public class ClinicaContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Tutor { Id = T1, Nome = "Naruto", CPF = "12312332124", Endereco = "Konoha", Telefone = "99999999", DataNascimento = "16/10/1997"},
            new Tutor { Id = T2, Nome = "Luffy", CPF = "12312332124", Endereco = "Grand Line", Telefone = "99999999", DataNascimento = "03/05/1990"}
            );
